...
section_rules = (
    ...
    # =====================================================================
    {
        ...
        "description":  "Name resolution via non-OpenDNS servers, and/or RFC-non-compliant protocol. Firewalls can "
                        "inspect this traffic, nevertheless. All sources hitting this rule must be identified and "
    ...
    # =====================================================================
    {
        "name":         "name-resolution-secure",
        "fromzone":     [settings.ZONE_INSIDE],
        "source":       [settings.DEFAULT_INSIDE_ADDRESS],
        "destination":  ["H-open_dns-208.67.222.222_32", "H-open_dns-208.67.220.220_32"],
        "application":  "dns-base",
        "service":      ["SVC-udp-53", "SVC-tcp-53"],
        "description":  "Name resolution via OpenDNS servers only, and via the DNS protocol version that firewalls can inspect"
    },
    {
        ...
        "description":  "We explicitly block all encrypted DNS traffic that firewalls are unable to inspect "
                        "because we do not decrypt this traffic"
    }
)
